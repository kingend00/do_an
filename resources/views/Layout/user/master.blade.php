	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			<li class="t-center m-b-13">
				<a href="{{ route('index') }}" class="txt19">Trang chủ</a>
				</li>

				<li class="t-center m-b-13">
				<a href="{{ route("F_menu.index") }}" class="txt19">Thực đơn</a>
				</li>

				<li class="t-center m-b-13">
				<a href="{{ route('F_seat.index') }}" class="txt19">Đặt bàn</a>
				</li>
				...
				<li class="t-center m-b-13">
				<a href="{{ route('news') }}" class="txt19">Sự kiện</a>
				</li>

				<li class="t-center m-b-13">
				<a href="{{ route('contact') }}" class="txt19">Liên hệ</a>
				</li>
				<li class="t-center m-b-13">
									
					<!-- Authentication Links -->
					@guest
						<li class="t-center m-b-13" ><a href="{{ route('B_user.index') }}" class="txt19">Đăng nhập</a></li>
						<li class="t-center m-b-13"><a href="{{ route('register') }}" class="txt19">Đăng kí</a></li>
					@else
						<li class="dropdown">
							<a href="#"  class="dropdown-toggle" data-toggle="dropdown" role="button"  aria-expanded="false" aria-haspopup="true" v-pre >
								{{ Auth::user()->name }} <span class="caret"></span>
							...
							<div class="dropdown-menu">
									@if (Auth::check()&& Auth::user()->roles == 4)
										<a href="{{ route('F_user.showAccount') }}" class="txt19">
											Thông tin tài khoản
										</a><br>
									@endif
									<a href="{{ route('logout') }}"
			...
			<a href="{{ route('F_menu.showCart') }}" class="txt19">MÓN ĐÃ ĐẶT</a>

			</li>

			<li class="t-center">
				<!-- Button3 -->
			<a href="{{ route('F_seat.index') }}" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
					Đặt bàn
				</a>
			</li>
		</ul>	
