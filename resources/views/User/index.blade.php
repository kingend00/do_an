					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								...
								<!-- Button2 -->
								<a href="{{ route('F_menu.index')}}/#dessert" class="btn2 flex-c-m txt5 ab-c-m size5" style="text-align:center">
									Dessert
								</a>
							</div>
						</div>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="{{route('news')}}/#{{$item->news_id}}"><img src="{{ URL::asset('images/background/'.$item->image)}}" width=100px height = 200px alt="IMG-INTRO"></a>
