                ...
                <form  method="post" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="nk-form">
                            ...
                            <div class="nk-navigation nk-lg-ic">
                                <a href="<?php echo e(route('login')); ?>" data-ma-action="nk-login-switch" data-ma-block="#l-register"><i class="notika-icon notika-plus-symbol"></i> <span>Đăng nhập</span></a>
                                <a href="<?php echo e(route('password.request')); ?>" data-ma-action="nk-login-switch" data-ma-block="#l-forget-password"><i>?</i> <span>Quên mật khẩu</span></a>
                            </div>
                </form>
            </div>
        </div>
